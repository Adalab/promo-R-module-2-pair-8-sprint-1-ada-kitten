...
const KittenDesc1 = 'Ruiseño, juguetón, le gusta estar tranquilo y que nadie le moleste. Es una maravilla acariciarle!';
const KittenRace1 = 'British Shorthair';

const KittenImg2 = 'https://images.emedicinehealth.com/images/article/main_image/cat-scratch-disease.jpg';
const KittenName2 = 'fiona';
const KittenName2UC = KittenName2.toUpperCase();
const KittenDesc2 = 'Ruiseño, juguetón, le gusta estar tranquilo y que nadie le moleste. Es una maravilla acariciarle!';
const KittenRace2 = 'British Shorthair';

const KittenImg3 = 'https://media-cldnry.s-nbcnews.com/image/upload/t_nbcnews-fp-1200-630,f_auto,q_auto:best/newscms/2019_39/3021711/190923-cat-pet-stock-cs-1052a.jpg';
const KittenName3 = 'cielo';
const KittenName3UC = KittenName3.toUpperCase();
const KittenDesc3 = 'Ruiseño, juguetón, le gusta estar tranquilo y que nadie le moleste. Es una maravilla acariciarle!';
